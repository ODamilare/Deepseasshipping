  ...
  return (
    <div className="coming-soon-page">
      ...
      <style jsx>{`
        ...
        .hero-content p { font-size: 1.2rem; margin-bottom: 1.5rem; margin-top: -1rem; color: #f0f0f0; }
        ...
        /* Info Section */
        .details h2 { font-size: 2rem; color: #0D314C; margin-bottom: 1rem; margin-top: 1.9rem; }
